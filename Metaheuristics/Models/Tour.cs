...
namespace Metaheuristics.Models
{
    ...
    public class Tour : List<Link>
    {
        ...
        /// <summary>
        /// Изчислява стойността на решението
        /// </summary>
        ...
        /// <summary>
        /// Създава връзка между два града
        /// </summary>
        ...
        /// <summary>
        /// Намира връзка към даден град от родителско решение, която ще се използва в детското решение
        /// </summary>
        ...
        /// <summary>
        /// Тества дали два града могат да бъдат свързани в детското решение
        /// </summary>
        ...
        /// <summary>
        /// Комбиниране на решения с цел създаване на детско решение
        /// </summary>
        ...
        /// <summary>
        /// Изпълнява мутация (промяна на връзка в маршрута)
        /// </summary>
